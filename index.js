...
app.post('/submit-quiz-form', (req, res) => {
  ...
  const department = "Computer Engineering"; // Define the department
  const session = "July 2024 - Dec 2024"; // Define the session
  ...
  // Pass department, session, and other data to the template
  res.render('help', { timetable, time_range, department, session });
});
